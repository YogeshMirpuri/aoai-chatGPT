...
import BPAI from "../../assets/BPAI.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Docu Search</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>AI powered Document Searcher</h2>
                            </Stack>
                        ) : (
